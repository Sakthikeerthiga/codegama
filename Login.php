            ...
            <div class="login-panel panel panel-success">
                ...
                <div class="panel-body">
                    <form role="form" method="post" action="Login.php">
                     ...
                     New Member.<a href="Registration.php">Sign up now</a>
                </div>
            </div>
        </div>
    </div>
...
if(isset($_POST['login']))
{
    ...
    $check_user="select * from students WHERE user_email='$user_email'AND user_pass='$user_pass'";
    ...
    if(mysqli_num_rows($run))
    {
        ...
        $_SESSION['user_id']=mysqli_fetch_array($run)['id'];
